...
import FooterCopyright from "@/src/app/components/common/footer/FooterCopyright";
import FooterCta from "@/src/app/components/common/footer/FooterCta";
import Subscription from "@/src/app/components/common/footer/Subscription";
function Footer() {
	return (
					...
					<div className="row">
						<div className="col-xl-4 col-md-12">
							<div className="sofax-footer-wrap mr-25">
								<Link href="/multi-page/home-eight">
									<Image src="/images/logo/logosq-hor2.png" width={160} height={160} alt="Logo" />
								</Link>
								<p className="all-para-color">
									Toupto Technologies has many plans for the future to work with great clients and continue to work
									with agencies.
								</p>
						...
						<div className="col-xl-4 col-md-4">
							<div className="sofax-footer-menu ml-50">
								<h5 className="all-heading-color">Company</h5>
								<ul>
									<li>
										<Link href="/services" className="all-para-color">Services</Link>
									</li>
									<li>
										<Link href="/portfolio" className="all-para-color">Portfolio</Link>
									</li>
									<li>
										<Link href="/about-us" className="all-para-color">About Us</Link>
									</li>
									<li>
										<Link href="/contact-us" className="all-para-color">Contact US</Link>
									</li>
									<li>
										<Link href="/blogs" className="all-para-color">Blogs</Link>
									</li>
								</ul>
							</div>
						</div>
						<div className="col-xl-4 col-md-4">
							<div className="sofax-footer-menu">
								<h5 className="all-heading-color">Subscribe to our newsletter</h5>
								<Subscription />
							</div>
						</div>
					</div>
