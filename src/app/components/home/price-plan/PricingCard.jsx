...
function PricingCard({ pricing: { plan, price, img, features, highlighted, featureIcon, imgWidth, ImgHeight }, frequency }) {
	return (
			...
			<div className="sofax-pricing-body">
				...
				<ul>
					{features.map((feature) => (
						<li key={feature}>
							<Image src={featureIcon} width={26} height={26} alt="feature Icon" />
							{feature}
						</li>
					))}
				</ul>
